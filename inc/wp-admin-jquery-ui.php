	...
	public function get_jquery_ui_demo() {
		...
		<div class="inside">
			...
			<table class="widefat" cellspacing="0">
				...
				<tr>
					<td class="row-title"><a href="#icons"><?php _e( 'Framework Icons', 'WpAdminStyle' ); ?></a></td>
				</tr>
				<tr class="alternate">
					<td class="row-title"><a href="#slider"><?php _e( 'Slider', 'WpAdminStyle' ); ?></a></td>
				</tr>
				<tr>
					<td class="row-title"><a href="#datepicker"><?php _e( 'Datepicker', 'WpAdminStyle' ); ?></a></td>
				</tr>
				<tr class="alternate">
					<td class="row-title"><a href="#anker_autocomplete"><?php _e( 'Autocomplete', 'WpAdminStyle' ); ?></a></td>
				</tr>
				<tr>
					<td class="row-title"><a href="#progressbar"><?php _e( 'Progressbar', 'WpAdminStyle' ); ?></a></td>
				</tr>
				<tr class="alternate">
					<td class="row-title"><a href="#anker_highlight"><?php _e( 'Highlight / Error', 'WpAdminStyle' ); ?></a></td>
				</tr>
			</table>
		...
		<p><a class="alignright button" href="javascript:void(0);" onclick="window.scrollTo(0,0);" style="margin:3px 0 0 30px;"><?php _e( 'scroll to top',
